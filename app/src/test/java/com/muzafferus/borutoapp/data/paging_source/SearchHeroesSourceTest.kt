...
import com.muzafferus.borutoapp.data.remote.FakeBorutoApi
...
class SearchHeroesSourceTest {
    ...
    @Test
    fun `Search api with empty hero name, assert empty heroes list and LoadingResult_Page`() =
        runBlockingTest {
    ...
    @Test
    fun `Search api with non_existing hero name, assert empty heroes list and LoadingResult_Page`() =
        runBlockingTest {
